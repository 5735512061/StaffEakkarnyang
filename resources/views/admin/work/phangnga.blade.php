        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row">
                <div class="col-md-9">
                  <p class="mb-0">ข้อมูลพนักงาน สาขาเมืองพังงา<p>
                </div>
              </div>
            </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>+ <?php echo number_format(DB::table('works')->where('staff_id',$value->id)->orderBy('id','desc')->value('wage'));?></td>
                    <td>+ <?php echo number_format(DB::table('works')->where('staff_id',$value->id)->orderBy('id','desc')->value('charge'));?></td>
                    ...
                    <td>
                      <a href="{{url('/admin/work-information')}}/{{$value->id}}">
      ...
      <div class="modal-body p-0">            
        <div class="card bg-secondary shadow border-0">
          <div class="card-body px-lg-12 py-lg-12">
            <form action="{{url('/admin/work-absence')}}" method="POST" enctype="multipart/form-data" autocomplete="off">@csrf
              <div class="row">
                <div class="col-md-6">
