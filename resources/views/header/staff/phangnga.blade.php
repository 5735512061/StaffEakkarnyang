          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row">
                ...
                <div class="col-md-3">
                  <a href="{{url('/header/history-phangnga')}}" class="btn btn-info">ข้อมูลพนักงานที่ลาออก</a>
                </div>
              </div>
            </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <form action="{{url('/header/delete-staff/')}}/{{$value->id}}" enctype="multipart/form-data" method="post">@csrf
